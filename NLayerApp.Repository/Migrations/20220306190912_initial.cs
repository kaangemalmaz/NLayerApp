    ...
    public partial class initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, new DateTime(2022, 3, 6, 22, 9, 12, 275, DateTimeKind.Local).AddTicks(7519), "Kalem 1", 100m, 20, null },
                    { 2, 1, new DateTime(2022, 3, 6, 22, 9, 12, 275, DateTimeKind.Local).AddTicks(7527), "Kalem 2", 100m, 20, null },
                    { 3, 1, new DateTime(2022, 3, 6, 22, 9, 12, 275, DateTimeKind.Local).AddTicks(7528), "Kalem 3", 100m, 20, null },
                    { 4, 2, new DateTime(2022, 3, 6, 22, 9, 12, 275, DateTimeKind.Local).AddTicks(7530), "Fen Kitabı", 200m, 40, null },
                    { 5, 3, new DateTime(2022, 3, 6, 22, 9, 12, 275, DateTimeKind.Local).AddTicks(7531), "Yazı Defteri", 300m, 60, null }
                });
